...
export function BuilderWorkspace(props: BuilderWorkspaceProps) {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-orange-50 text-orange-950">
      <TripToolbar draft={props.draft} viewMode={props.viewMode} onViewModeChange={props.onViewModeChange} onBack={props.onBack} onSave={props.onSaveDraft} onReset={props.onReset} onSavedTrips={props.onSavedTrips} onShare={props.onShare} />
